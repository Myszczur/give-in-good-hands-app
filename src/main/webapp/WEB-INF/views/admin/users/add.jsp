...
<header class="header--form-page">
    <nav class="container container--70">
        ...
        <div class="steps--container">
            <h2>
                <a href="<c:url value="/admin/admins"/>" class="btn">Lista Adminów</a>
            </h2>
        </div>
    ...
    <section class="steps">
        <div class="contact">
            <span class="description" style="font-size: 180%"><h3>Dodaj nowego Admina</h3></span>

            <form:form modelAttribute="user">
                <div class="form-group">
                    <form:select path="email" items="${users}"
                    itemLabel="email" itemValue="id"/>
